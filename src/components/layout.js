  ...
  render() {
    ...
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <main className="container flex-auto px-4 md:px-0 max-w-6xl mx-auto -mt-32">
              ...
              <div className="container mx-auto flex items-center">
                <div className="flex w-1/2 pl-4 text-sm">
                  <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                    <li className="mr-2">
                      <a className="inline-block py-2 px-2 text-white no-underline hover:underline" href="post.html">POSTS</a>
                    </li>
                  </ul>
                </div>
